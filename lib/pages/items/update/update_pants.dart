...
class EditPantsPage extends StatefulWidget {
  final Items item;

  const EditPantsPage({super.key, required this.item});

  @override
  _EditPantsPageState createState() => _EditPantsPageState();
}

class _EditPantsPageState extends State<EditPantsPage> {
